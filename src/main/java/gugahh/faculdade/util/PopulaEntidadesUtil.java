...
public class PopulaEntidadesUtil {
	...
	public static void cadastraUFs(EntityManager em) {
		...
		UF rj = ufDAO.novaUF(SIGLA_UF_RJ, "Rio de Janeiro");
		UF sp = ufDAO.novaUF(SIGLA_UF_SP, "São Paulo");
		UF es = ufDAO.novaUF(SIGLA_UF_ES, "Espírito Santo");
		UF mg = ufDAO.novaUF(SIGLA_UF_MG, "Minas Gerais");
	}
